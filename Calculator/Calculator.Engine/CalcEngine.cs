...
{
    public class CalcEngine : BindableBase, ICalcEngine
    {
        private bool point = true;
        private int count = 0;

        private bool _calc1slected;
        public bool Calc1Selected
        {
            get { return _calc1slected; }
            set
            {
                SetProperty(ref _calc1slected, value);
            }
        }

        private bool _calc2slected;
        public bool Calc2Selected
        {
            get { return _calc2slected; }
            set { SetProperty(ref _calc2slected, value); }
        }
